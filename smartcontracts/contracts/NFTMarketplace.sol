...
contract NFTMarketplace is ERC1155Holder, ERC721Holder {
    ...
    event ListingCreated(uint256 id);
    event ListingCancelled(uint256 id);
    event ItemBought(uint256 indexed id, address indexed from, address indexed to, uint256 price, uint256 datetime);
    ...
    function buyItem(uint256 _listingId) external {
        ...
        emit ItemBought(_listingId, listing.seller, msg.sender, listing.price, block.timestamp);
    }
